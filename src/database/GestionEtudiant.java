...
public class GestionEtudiant extends JInternalFrame {
    ...
    public GestionEtudiant()  {
        ...
        textFieldNom.addFocusListener(new EcouteurFocus(lb_help, textFieldNom, placeholderNom));
        ...
        textFieldPrenom.addFocusListener(new EcouteurFocus(lb_help, textFieldPrenom, placeholderPrenom));
        ...
        textFieldCIN.addFocusListener(new EcouteurFocus(lb_help, textFieldCIN, placeholderCIN));
        ...
        textFieldMoyenne.addFocusListener(new EcouteurFocus(lb_help, textFieldMoyenne, placeholderMoyenne));
